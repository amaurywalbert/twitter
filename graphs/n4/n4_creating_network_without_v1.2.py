...
#		if G.has_edge(ego,alter):							### Se existe uma aresta entre o ego e o autor
...
output_dir = "/home/amaury/graphs/n4/graphs_without/" ############################################ Diretório para armazenamento dos arquivos das listas de arestas 
output_dir_errors = "/home/amaury/graphs/n4/error_without/" ##################################### Diretório para armazenamento dos erros
output_overview = "/home/amaury/graphs/n4/overview_without.json" ##################################### Diretório contendo arquivos com informações sobre a construção das redes. 
