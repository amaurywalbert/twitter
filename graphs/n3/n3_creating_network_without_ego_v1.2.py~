...
## # INPUT:
##		- Lista de Egos (egos)
##		- Lista autores de likes (alters) de cada Ego - Formação do conjunto de Alters
##		- Lista autores de likes de cada Alter (ids)
##
## # ALGORITMO
##					0 - Para cada ego[i]:
...
def read_arq_bin(file):
	with open(file, 'r') as f:	 
		...
		while f.tell() < tamanho:
			...
			tweet, author = favorites_struct.unpack(buffer)
...
#			plt_graph(ego,G)		
	...
	t = tf - ti																			# Calcula o tempo gasto com o processo de criação dos grafosfos
...
output_dir = "/home/amaury/graphs/n3/graphs_without_ego/" ############################################ Diretório para armazenamento dos arquivos das listas de arestas 
output_dir_errors = "/home/amaury/graphs/n3/error_without_ego/" ##################################### Diretório para armazenamento dos erros
output_overview = "/home/amaury/graphs/n3/overview_without_ego.json" ##################################### Diretório contendo arquivos com informações sobre a construção das redes. 
