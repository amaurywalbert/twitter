...
################################################################################################
def ego_net(ego,alters_set):												# Função recebe o id do ego, a lista de alters e o número ordinal do ego corrente
...
def main():
	...
	for file in os.listdir(egos_dir):										# Para cada arquivo de Ego no diretório
		...
		G = ego_net(ego,alters_set)										# Inicia função de criação do grafo (lista de arestas) para o ego corrente
		print
