		...
		for file in os.listdir(graphs):
			...
			try:
				if ud is False:		# Para grafo Directed
					...
					execute = subprocess.Popen(["/home/amaury/algoritmos/Infomap/Infomap","-i link-list", str(graphs)+str(file), str(output), "--out-name "+str(ego_id), "-N 10", "--undirdir", "--two-level", "--map"], stdout=subprocess.PIPE)
