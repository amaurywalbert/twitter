...
#      2. parameters are *CASE-SENSITIVE*, e.g., -Onc is not -onc
	...
	if [ $R1 == 1 ] && [ $R2 == 1 ]; then
		...
		if [ $3 == "D" ]; then
			java -jar /home/amaury/algoritmos/GANXiS_v3.0.2/GANXiS_v3.0.2/GANXiSw.jar -i $1 -d $2 # Directed Networks
		else
			java -jar /home/amaury/algoritmos/GANXiS_v3.0.2/GANXiS_v3.0.2/GANXiSw.jar -i $1 -Sym 1 -d $2 #Undirected network	
		fi
	fi		 
}
