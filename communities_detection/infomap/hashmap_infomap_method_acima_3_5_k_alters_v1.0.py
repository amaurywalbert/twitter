...
######################################################################################################################
	...
	output = "/home/amaury/communities_hashmap_acima_3_5_k_alters/"+str(g_type1)+"/"+str(alg)+"/raw/"+str(net)+"/10/"
	graphs = "/home/amaury/graphs_hashmap_acima_3_5_k_alters/"+str(net)+"/"+str(g_type1)+"/"
...
######################################################################################################################
	...
	output = "/home/amaury/communities_hashmap_acima_3_5_k_alters/"+str(g_type2)+"/"+str(alg)+"/raw/"+str(net)+"/10/"
	graphs = "/home/amaury/graphs_hashmap_acima_3_5_k_alters/"+str(net)+"/"+str(g_type2)+"/"
