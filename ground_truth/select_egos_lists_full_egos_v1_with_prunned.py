...
######################################################################################################################
qtde_egos = 'full_with_prunned'	#10, 50, 100, 500 ou 'full'
egos_set = "/home/amaury/coleta/n1/egos_friends/"+str(qtde_egos)+"/bin/" # Conjunto de egos - Apenas para pegar o id de cada ego em cada conjunto (50-100-500-full)
...
all_egos_lists = "/home/amaury/coleta/ground_truth/egos_lists/"+str(qtde_egos)+"/all/bin/" 
owner_egos_lists ="/home/amaury/coleta/ground_truth/egos_lists/"+str(qtde_egos)+"/owner/bin/"
subs_egos_lists ="/home/amaury/coleta/ground_truth/egos_lists/"+str(qtde_egos)+"/subs/bin/"

formato = 'l'				################################################### Long para o código ('l')	
