...
##		Status - Versão 7.0
##
##					7.1.1 - OK	- Coletando todas as litas - adicionado Método API.Cursor
##					7.1.2 - OK - Verificando por limites usando apenas o Tweepy
##					7.1.3 - OK - Adicionar apenas o necessário para a coleta dos egos:
##						7.1.3.1 - - Listas com pelo menos 5 membros;
##						7.1.3.2 - - Users com no mínimo 02 lista (inscrito ou dono);
##						7.1.3.3 - - Coleta snowball de egos a partir de seeds iniciais e crescendo com a análise dos membros das listas selecionadas.
##
##					7.1.4 - OK - Armazenamento dos ids das listas...
##					7.1.5 - OK - verificando pelo id dos users...
##
##					7.1.6 - OK - Gerenciador de chaves usando tweepy - Usando chaves 0 a 4 - outro script tá usando 5 a 9.
##
##					7.1.7 - Status - TESTE - Não verificar duplicidade na lista de seeds (fazer isso apenas na lista de users_verificados)! - Evitar o problema de demora na leitura dos arquivos (enormes)
...
##				users_collected.close()
		...
		members_lists_err = open("/home/amaury/coleta/ego_collection/error/members_list.lists_err", "a+") # Abre o arquivo para gravação no final do arquivo
...
def search_lists(user):
	...
	try:
		...
		agora = datetime.datetime.strftime(datetime.datetime.now(), '%Y%m%d%H%M')			# Recupera o instante atual na forma AnoMesDiaHoraMinuto
		lists_err = open("/home/amaury/coleta/ego_collection/error/lists_collect.lists_err", "a+") # Abre o arquivo para gravação no final do arquivo
