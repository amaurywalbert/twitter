...
def save_error(user,reason):
	...
	error={}
	with open(error_dir+"timeline_collect_wait_APP6.err", "a+") as outfile:								# Abre o arquivo para gravação no final do arquivo
...
egos_followees_dir = "/home/amaury/dataset/n9/egos_subconjunto_03/bin/"				# Arquivo contendo a lista dos usuários ego já coletados - Subconjunto 03
