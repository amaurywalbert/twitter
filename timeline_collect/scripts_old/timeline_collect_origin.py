# -*- coding: latin1 -*-
################################################################################################
# Script para coletar tweets da timeline de usuários previamente selecionados
import tweepy
import datetime
import sys
import time
...
#Coleta os tweets paginados em 200 em cada requisição (incluindo Retweets - RT)
  try:
    timeline = api.user_timeline(user, max_id=max_id,count=200, include_rts=1)
  	 ...
  	 ##
  	 ##
  	 ##Adicionar recurso para registrar e/ou tratar esses erros...
  	 ##
  	 ##
  	 ##
