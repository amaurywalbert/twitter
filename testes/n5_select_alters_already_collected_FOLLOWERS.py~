...
def main():
	...
	for file in os.listdir(fonte):
		followers_list = read_arq_bin(fonte+file) # Função para converter o binário de volta em string em formato json.
		if followers_list:
...
origem = "/home/amaury/coleta_old/n5/alters_followers/bin/"
