...
favorites_collected_dir = "/home/amaury/coleta/favorites_collect/"+str(qtde_egos)+"/json/"# Arquivo contendo a lista dos usuários ego já coletados
data_dir = "/home/amaury/coleta/n3/favorites_collect/alters/"+str(qtde_egos)+"/bin/" ###### Diretório para armazenamento dos arquivos
error_dir = "/home/amaury/coleta/n3/favorites_collect/alters/"+str(qtde_egos)+"/error/" ### Diretório para armazenamento dos arquivos de erro
