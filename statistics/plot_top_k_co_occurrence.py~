...
def color_bar(metric,_aa_avg,_as_avg,_ar_avg,_al_avg,_am_avg, _sa_avg,_ss_avg,_sr_avg,_sl_avg,_sm_avg, _ra_avg,_rs_avg,_rr_avg,_rl_avg,_rm_avg, _la_avg,_ls_avg,_lr_avg,_ll_avg,_lm_avg, _ma_avg,_ms_avg,_mr_avg,_ml_avg,_mm_avg):
	...
	raw_data = {'Follow': [_ar_avg['media'],_al_avg['media'],_am_avg['media']],
			'Retweets': [_rr_avg['media'],_rl_avg['media'],_rm_avg['media']],
			'Likes': [_lr_avg['media'],_ll_avg['media'],_lm_avg['media']],
			'Mentions': [_mr_avg['media'],_ml_avg['media'],_mm_avg['media']]
        }
        
	df = pd.DataFrame(raw_data, columns = ['Follow','Retweets','Likes','Mentions'],columns_y = ['Retweets','Likes','Mentions'])
	print ("Média:")	
	print df
	
	raw_data_dp = {'Follow': [_ar_avg['desvio_padrao'],_al_avg['desvio_padrao'],_am_avg['desvio_padrao']],
			'Retweets': [_rr_avg['desvio_padrao'],_rl_avg['desvio_padrao'],_rm_avg['desvio_padrao']],
...
#	plt.matshow(df,cmap=plt.cm.get_cmap('Blues', 20))
	...
	plt.yticks(range(len(df.columns_y)), df.columns_y,rotation=30,size=9)
