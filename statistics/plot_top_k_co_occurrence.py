...
def color_bar(metric,_aa_avg,_as_avg,_ar_avg,_al_avg,_am_avg, _sa_avg,_ss_avg,_sr_avg,_sl_avg,_sm_avg, _ra_avg,_rs_avg,_rr_avg,_rl_avg,_rm_avg, _la_avg,_ls_avg,_lr_avg,_ll_avg,_lm_avg, _ma_avg,_ms_avg,_mr_avg,_ml_avg,_mm_avg,output_dir):
	...
	raw_data = {'Follow': [_aa['media'],_ar['media'],_al['media'],_am['media']],
        'Retweets': [_ra['media'],_rr['media'],_rl['media'],_rm['media']],
        'Likes': [_la['media'],_lr['media'],_ll['media'],_lm['media']],
        'Mentions': [_ma['media'],_mr['media'],_ml['media'],_mm['media']]
        }
	...
	raw_data_dp = {'Follow': [_aa['desvio_padrao'],_ar['desvio_padrao'],_al['desvio_padrao'],_am['desvio_padrao']],
        'Retweets': [_ra['desvio_padrao'],_rr['desvio_padrao'],_rl['desvio_padrao'],_rm['desvio_padrao']],
        'Likes': [_la['desvio_padrao'],_lr['desvio_padrao'],_ll['desvio_padrao'],_lm['desvio_padrao']],
        'Mentions': [_ma['desvio_padrao'],_mr['desvio_padrao'],_ml['desvio_padrao'],_mm['desvio_padrao']]
        }
