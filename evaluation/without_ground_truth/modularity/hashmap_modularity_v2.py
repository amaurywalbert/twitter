...
######################################################################
	...
	if not os.path.isdir(dataset_dir1):
		...
		output_dir3 = str(output)+alg+"/"+str(graph_type)+"/modularity/full/"
...
######################################################################
	...
	if not os.path.isdir(dataset_dir2):
		...
		output_dir2 = str(output)+alg+"/"+str(graph_type)+"/modularity/without_singletons/"
...
######################################################################
	...
	if not os.path.isdir(dataset_dir4):
		...
		output_dir4 = str(output)+alg+"/"+str(graph_type)+"/modularity/without_singletons/"
