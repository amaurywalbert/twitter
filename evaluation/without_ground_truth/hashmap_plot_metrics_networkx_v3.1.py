...
##
##					ATENÇÃO - SÓ FAZ CÁLCULOS PARA GRAFOS NÃO DIRECIONADOS!!! PARA GRAFOS NÃO DIRECIONADOS O RESULTADO É 0
##
######################################################################################################################################################################
...
#		alg = "infomap_without_weight"
	...
	metrics = ["average_degree","conductance","cut_ratio","density","expansion","normalized_cut","separability","clustering"]
...
source = "/home/amaury/Dropbox/evaluation_hashmap/without_ground_truth/networkx/"
output = "/home/amaury/Dropbox/evaluation_hashmap_statistics/without_ground_truth/networkx/"
