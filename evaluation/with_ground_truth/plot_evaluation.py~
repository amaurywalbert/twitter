...
################################################################################################  MANTER -- Dá pra exportar a tabela depois...
	...
	trace1 = go.Bar(x = dataset[1][1], y = dataset[1][0], error_y=dict(type='data',array=dataset[1][2], color='#E6842A', visible=True), name="Grafo COM ego", marker=dict(color='darkblue'))
	trace2 = go.Bar(x = dataset[1][1], y = dataset[2][0], error_y=dict(type='data',array=dataset[2][2], color='#E6842A', visible=True), name="Grafo COM ego - Comunidade SEM singletons", marker=dict(color='royalblue'))
	trace3 = go.Bar(x = dataset[1][1], y = dataset[3][0], error_y=dict(type='data',array=dataset[3][2], color='#E6842A', visible=True), name="Grafo SEM ego", marker=dict(color='blue'))
	trace4 = go.Bar(x = dataset[1][1], y = dataset[4][0], error_y=dict(type='data',array=dataset[4][2], color='#E6842A', visible=True), name="Grafo SEM ego - Comunidade SEM singletons", marker=dict(color='lightblue'))

	trace5 = go.Bar(x = dataset[1][1], y = dataset[5][0], error_y=dict(type='data',array=dataset[5][2], color='#E6842A', visible=True), name="Grafo COM ego", marker=dict(color='darkgreen'))
	trace6 = go.Bar(x = dataset[1][1], y = dataset[6][0], error_y=dict(type='data',array=dataset[6][2], color='#E6842A', visible=True), name="Grafo COM ego - Comunidade SEM singletons", marker=dict(color='seagreen'))
	trace7 = go.Bar(x = dataset[1][1], y = dataset[7][0], error_y=dict(type='data',array=dataset[7][2], color='#E6842A', visible=True), name="Grafo SEM ego", marker=dict(color='green'))
	trace8 = go.Bar(x = dataset[1][1], y = dataset[8][0], error_y=dict(type='data',array=dataset[8][2], color='#E6842A', visible=True), name="Grafo SEM ego - Comunidade SEM singletons", marker=dict(color='lightgreen'))
