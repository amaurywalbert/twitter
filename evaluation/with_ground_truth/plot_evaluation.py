...
################################################################################################  MANTER -- Dá pra exportar a tabela depois...
	...
	trace3 = go.Bar(x = dataset[3][1], y = dataset[3][0], error_y=dict(type='data',array=dataset[3][2], color='#E6842A', visible=True), name="JACCARD - Grafo COM ego - Threshold - "+str(dataset[3][3]), marker=dict(color='darkgreen'))
	trace4 = go.Bar(x = dataset[4][1], y = dataset[4][0], error_y=dict(type='data',array=dataset[4][2], color='#E6842A', visible=True), name="JACCARD - - Grafo Sem ego - Threshold - "+str(dataset[4][3]), marker=dict(color='seagreen'))
