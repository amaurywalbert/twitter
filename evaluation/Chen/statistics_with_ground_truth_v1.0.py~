...
##				
##							0.1 - Separa arquivos por métrica
...
def prepare_data(data_dir,output_dir):
	...
	if not os.path.isdir(data_dir):
		...
		for file in os.listdir(data_dir):
			...
			print ("\n##################################################")
			print ("Recuperando dados da rede "+str(network)+" - "+str(data_dir)+"\n")	
...
# Salvando Gráficos
	...
	for k, v in data_print1.iteritems():
		...
		plot_evaluation_chen.plot_full(output_graphics,data_print1[k],data_print2[k],data_print3[k],data_print4[k],k,alg)		
...
source = "/home/amaury/Dropbox/Chen_software_results/with_ground_truth/"
output = "/home/amaury/Dropbox/Chen_software_statistics/with_ground_truth/"
######################################################################################################################
