...
##						STATUS - USANDO SUBCONJUNTO DE EGOS - Subconjunto 2
##
## 
######################################################################################################################################################################
...
def save_error(user,reason):
	...
	error={}
	with open(error_dir+"timeline_collect_wait_APP3.err", "a+") as outfile:								# Abre o arquivo para gravação no final do arquivo
...
egos_friends_dir = "/home/amaury/dataset/n1/egos_subconjunto_02/bin/"			#### Arquivo contendo a lista dos usuários ego do subconjunto de 500 - Subconjunto 02 com 170
