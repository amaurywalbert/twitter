...
## 
######################################################################################################################################################################
def histogram(data,output_dir,elements):
	...
	if data.__class__.__name__ == 'dict':
		...
		for k,v in data.iteritems():
			_data.append(v)
		histogram_print(_data,output_dir,elements)
		normalized_print(_data,output_dir,elements)

	elif data.__class__.__name__ == 'list':
		histogram_print(data,output_dir,elements)
		normalized_print(data,ouput_dir,elements)
...
# HTML
######################################################################################################################################################################
def normalized_print(data,output_dir,elements):
	...
	plotly.offline.plot(fig, filename=output_dir+"histogram_dist_degree.html")
...
# Histograma
######################################################################################################################################################################
def histogram_print(data,output_dir,elements):
	print ("\nCriando histograma...")
	print ("Salvando dados em: "+str(output_dir)+"\n")
