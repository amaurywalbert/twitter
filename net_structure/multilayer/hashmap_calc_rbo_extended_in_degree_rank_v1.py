...
######################################################################################################################################################################
##		Status - Versão 1 - Script para calcular a sobreposição de Rankings usando Rank-Biased Overlap - Extended, para o ranking de in-degree.
...
def main():
	...
	print "################################################################################"
	print"																											"
	print" Cálculo da sobreposição de ranks entre Layers													"
	print"																											"
	print"#################################################################################"
	print
			...
			for ego,v in dictionary.iteritems():
				...
				for net in nets:
					...
					if not os.path.isdir(edge_list):																				# Verifica se diretório existe	
						...
						in_degree_rank = get_in_degree_rank(G)																	# Retorna o ranking  - por enquanto desordenado - da camada x
