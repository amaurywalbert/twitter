...
def save_json(dataset_json):
	with open(output_dir_json+"overlapping_edges_v2.json","w") as f:
...
def main():
	...
	print
	i=0
	if os.path.exists(output_dir_json+"overlapping_edges_v2.json"):
		print ("Arquivo de destino já existe!"+str(output_dir_json+"overlapping_edges_v2.json"))
	else:
		...
		with open(output_dir_txt+"overlapping_edges_v2.txt",'w') as out_file:
