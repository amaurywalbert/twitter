...
#	plt.matshow(df,cmap=plt.cm.get_cmap('Blues', 20))
	...
	plt.savefig(output+"Closeness_Centr.png")
	plt.show()
...
######################################################################################################################################################################
#
# Calcular correlação entre duas camadas...
#
######################################################################################################################################################################
...
data_dir = "/home/amaury/Dropbox/net_structure_hashmap/multilayer/graphs_with_ego/json/basics/"	# Diretório com arquivos JSON com métricas e propriedades Calculadas
output_dir = "/home/amaury/Dropbox/net_structure_hashmap_statistics/multilayer/graphs_with_ego/basics/"	# Diretório para Salvar os gráficos...
